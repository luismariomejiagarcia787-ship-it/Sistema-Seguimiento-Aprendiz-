...
<head>
    ...
    <title>SSA - <?php echo $__env->yieldContent('title', 'Sistema de Seguimiento al Aprendiz'); ?></title>
...
<div class="d-flex">
    ...
    <nav class="sidebar d-flex flex-column">
        ...
        <ul class="nav flex-column mt-2 flex-grow-1">
            ...
            <?php if(Auth::user()->esAdministrador() || Auth::user()->esInstructor()): ?>
            <li class="nav-item">
                <a href="<?php echo e(route('aprendices.index')); ?>" class="nav-link <?php if(request()->routeIs('aprendices.*')): ?> active <?php endif; ?>">
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('fichas.index')); ?>" class="nav-link <?php if(request()->routeIs('fichas.*')): ?> active <?php endif; ?>">
                    <i class="bi bi-journal-bookmark-fill"></i> Fichas
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(route('instructores.index')); ?>" class="nav-link <?php if(request()->routeIs('instructores.*')): ?> active <?php endif; ?>">
            ...
            <?php if(Auth::user()->esAdministrador() || Auth::user()->esInstructor()): ?>
            <li class="nav-item">
                <a href="<?php echo e(route('actividades.index')); ?>" class="nav-link <?php if(request()->routeIs('actividades.*')): ?> active <?php endif; ?>">
                    <i class="bi bi-card-checklist"></i> Actividades
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(route('calificaciones.index')); ?>" class="nav-link <?php if(request()->routeIs('calificaciones.*')): ?> active <?php endif; ?>">
                    <i class="bi bi-123"></i> Calificaciones
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(route('reportes.index')); ?>" class="nav-link <?php if(request()->routeIs('reportes.*')): ?> active <?php endif; ?>">
                    <i class="bi bi-bar-chart-fill"></i> Reportes
                </a>
            </li>
            <?php endif; ?>
            <?php if(Auth::user()->esAprendiz()): ?>
            <li class="nav-item">
                <a href="<?php echo e(route('actividades.index')); ?>" class="nav-link <?php if(request()->routeIs('actividades.*')): ?> active <?php endif; ?>">
            ...
            <?php if(Auth::user()->aprendiz): ?>
            <li class="nav-item">
                <a href="<?php echo e(route('aprendices.show', Auth::user()->aprendiz)); ?>" class="nav-link">
        ...
        <div class="p-3 border-top border-white border-opacity-25">
            <div class="d-flex align-items-center gap-2 mb-2">
                <img src="<?php echo e(Auth::user()->foto_url); ?>" class="rounded-circle" width="34" height="34" alt="">
                <div>
                    <div class="text-white fw-semibold" style="font-size:.82rem; line-height:1.2"><?php echo e(Auth::user()->name); ?></div>
                    <span class="badge bg-warning text-dark badge-role"><?php echo e(ucfirst(Auth::user()->rol)); ?></span>
                </div>
            </div>
    ...
    <div class="main-content">
        <nav class="navbar-top d-flex align-items-center justify-content-between px-3 py-2">
            <span class="fw-semibold text-secondary"><?php echo $__env->yieldContent('page-title', 'Panel'); ?></span>
...
<?php /**PATH C:\Users\PC Lenovo\Downloads\SSA_sistemamejorado\sistemamejorado\resources\views/layouts/app.blade.php ENDPATH**/ ?>